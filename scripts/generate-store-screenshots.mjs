...
const T = {
  ...
  amber: '#0EA5E9', amberB: '#38BDF8', amberSoft: 'rgba(14,165,233,0.14)', onAmber: '#0A0C11',
...
const CAT = { ohms: '#38BDF8', voltage: '#38BDF8', wire: '#34D399', conduit: '#A78BFA', box: '#FB7185', bend: '#2DD4BF', transformer: '#818CF8', power: '#FB923C' };
